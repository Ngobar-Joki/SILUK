            ...
            <div className="register-wrapper">
                <div className="register-card">
                    <div className="register-header">
                        {/* Enhanced cooperative logo matching Login page */}
                        ...
                        <h1 className="register-title">
                            <span className="title-gradient">Daftar Akun</span>
                        </h1>
                    ...
                    {/* Registration Form - Keeping the existing form structure */}
